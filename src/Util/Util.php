...
namespace Digikraaft\Watupay\Util;
...
abstract class Util
{
    ...
    /**
     * Converts a response from the Watupay API to the corresponding PHP object.
     *
     * @param array $resp the response from the Watupay API
     *
     * @return array|object
     */
