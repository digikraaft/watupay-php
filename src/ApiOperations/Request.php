...
trait Request
{
    ...
    /**
     *  Response from requests made to Watupay.
     *
     * @var mixed
     */
    ...
    public static function staticRequest($method, $url, $params = [], $return_type = 'obj')
    {
        ...
        return \Digikraaft\Watupay\Util\Util::convertArrayToObject(static::getResponse());
    }
    ...
    {
        $authBearer = 'Bearer '.Watupay::$apiKey;

        static::$client = new Client(
            [
                'base_uri' => Watupay::$apiBase,
                'headers' => [
